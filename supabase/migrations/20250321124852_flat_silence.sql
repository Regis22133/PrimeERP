/*
  # Remove Default Cost Centers and Clean Up Table

  1. Changes
    - Drop existing triggers and functions
    - Drop existing policies
    - Truncate cost_centers table to remove all existing data
    - Recreate table structure without automatic population
...
-- Truncate the cost_centers table to remove all existing data
